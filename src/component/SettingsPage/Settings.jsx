...
const Settings = () => {
  ...
  useEffect(() => {
    ...
    if (!userId) {
      ...
      axios.get(`https://kopyrightit-backend-zdfw.onrender.comapi/user/email/${userId}`)
        .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://kopyrightit-backend-zdfw.onrender.comapi/settings', formData);
