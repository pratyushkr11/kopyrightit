...
const ForgotPassword = () => {
  ...
  useEffect(() => {
    ...
    axios.post('https://kopyrightit-backend-zdfw.onrender.com/api/verify-reset-url', { token: token1 })
      .then(result => {
  ...
  const resetPassword = async (e) => {
    ...
    if (newPassword === '' || confirmPassword === '') {
      ...
      try {
        const url = 'https://kopyrightit-backend-zdfw.onrender.com/api/change-password';
